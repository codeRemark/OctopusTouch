...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "US Mac";  // Default keyboard layout
  ...
  this.VKI_layout['US Standard'] = {
   ...
   this.VKI_layout['US International'] = {
	...
	//@@ 
	this.VKI_layout['US Mac'] =  {
			'name': 'US Mac', 'keys': [
				[['`', '~'], ['1', '!', '\u00a1', '\u00b9'], ['2', '@', '\u00b2'], ['3', '#', '\u00b3'], ['4', '$', '\u00a4', '\u00a3'], ['5', '%', '\u20ac'], ['6', '^', '\u00bc'], ['7', '&', '\u00bd'], ['8', '*', '\u00be'], ['9', '(', '\u2018'], ['0', ')', '\u2019'], ['-', '_', '\u00a5'], ['=', '+', '\u00d7', '\u00f7'], ['Bksp', 'Bksp']],
				[['Tab', 'Tab'], ['q', 'Q', '\u00e4', '\u00c4'], ['w', 'W', '\u00e5', '\u00c5'], ['e', 'E', '\u00e9', '\u00c9'], ['r', 'R', '\u00ae'], ['t', 'T', '\u00fe', '\u00de'], ['y', 'Y', '\u00fc', '\u00dc'], ['u', 'U', '\u00fa', '\u00da'], ['i', 'I', '\u00ed', '\u00cd'], ['o', 'O', '\u00f3', '\u00d3'], ['p', 'P', '\u00f6', '\u00d6'], ['[', '{', '\u00ab'], [']', '}', '\u00bb'], ['\\', '|', '\u00ac', '\u00a6']],
				[['Caps', 'Caps'], ['a', 'A', '\u00e1', '\u00c1'], ['s', 'S', '\u00df', '\u00a7'], ['d', 'D', '\u00f0', '\u00d0'], ['f', 'F'], ['g', 'G'], ['h', 'H'], ['j', 'J'], ['k', 'K'], ['l', 'L', '\u00f8', '\u00d8'], [';', ':', '\u00b6', '\u00b0'], ['\'', '"', '\u00b4', '\u00a8'], ['Enter', 'Enter']],
				[['Shift', 'Shift'], ['z', 'Z', '\u00e6', '\u00c6'], ['x', 'X'], ['c', 'C', '\u00a9', '\u00a2'], ['v', 'V'], ['b', 'B'], ['n', 'N', '\u00f1', '\u00d1'], ['m', 'M', '\u00b5'], [',', '<', '\u00e7', '\u00c7'], ['.', '>'], ['/', '?', '\u00bf'], ['Shift', 'Shift']],
				[['Switch', 'Switch'],['Ctrl', 'Ctrl'], ['Command', 'Command'],[' ', ' ', ' ', ' '], ['Alt', 'Alt']]
			],
		'lang': ['en']};  
    ...
    var tr = document.createElement('tr');
      var th = document.createElement('th');
        ...
        var strong = document.createElement('strong');
            strong.appendChild(document.createTextNode('Input'));
            strong.title = this.VKI_i18n['06'];
          VKI_addListener(strong, 'click', function() {  KeyListener.onCommandBlankSpaceKey(); return ;self.VKI_close(); }, false);
  ...
  function VKI_keyClick() {
    ...
    //@step
    VkInterrupter.process(character);
          ...
          var tr = document.createElement('tr');
            for (var y = 0, lkey; lkey = lyt[y++];) {
              var td = document.createElement('td');
                ...
                //@case
                 case "Command":
                  VKI_addListener(td, 'click', (function(type) { return function() {  KeyListener.onCommandComboKey(Keystoke.tab);
                return false;    }})(lkey[1]), false);

                	break;
                 case "Switch":
                   VKI_addListener(td, 'click', (function(type) {
                   		 return function() {   
                   		  KeyListener.onCommandComboKey('`');
									 return false;  }})(lkey[1]), false);
                  ...
                  case "Bksp":
                    VKI_addListener(td, 'click', function() {
                      ...
                      KeyListener.onKeyPress(Keystoke.delete);
                  ...
                  case "Enter":
                    VKI_addListener(td, 'click', function() {
                   	 ...
                   	 KeyListener.onKeyPress(Keystoke.enter);
